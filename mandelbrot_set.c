...
static void gen_uniforms(mandelbrot_set_t *js);
...
void use_mandelbrot_set_shader(mandelbrot_set_t *js)
{
...
void update_mandelbrot_set_Scale(mandelbrot_set_t *js, float a, float b)
{
...
void update_mandelbrot_set_Center(mandelbrot_set_t *js, float a, float b)
{
...
void update_mandelbrot_set_Size(mandelbrot_set_t *js, int a, int b)
{
...
void update_mandelbrot_set_MaxIteration(mandelbrot_set_t *js, int a)
{
	js->MaxIteration.value_i1 = a;
	set_uniform(js->program, &js->MaxIteration);
}

void destroy_mandelbrot_set(mandelbrot_set_t *js)
{
			...
			case GLFW_KEY_W:
				{
					...
					update_mandelbrot_set_Scale(js, v1, v2);
				}
				break;
			...
			case GLFW_KEY_V:
				{
					...
					update_mandelbrot_set_Center(js, x, y);
				}
				break;
		}
	}
