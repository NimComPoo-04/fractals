...
static void gen_uniforms(newton_raphson_t *js);
...
void use_newton_raphson_shader(newton_raphson_t *js)
{
...
void update_newton_raphson_Scale(newton_raphson_t *js, float a, float b)
{
...
void update_newton_raphson_Center(newton_raphson_t *js, float a, float b)
{
...
void update_newton_raphson_Size(newton_raphson_t *js, int a, int b)
{
...
void update_newton_raphson_MaxIteration(newton_raphson_t *js, int a)
{
	js->MaxIteration.value_i1 = a;
	set_uniform(js->program, &js->MaxIteration);
}

void destroy_newton_raphson(newton_raphson_t *js)
{
			...
			case GLFW_KEY_W:
				{
					...
					update_newton_raphson_Scale(js, v1, v2);
				}
				break;
			...
			case GLFW_KEY_V:
				{
					...
					update_newton_raphson_Center(js, x, y);
				}
				break;
		}
	}
